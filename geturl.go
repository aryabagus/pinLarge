...
func handler(w http.ResponseWriter, r *http.Request) {
	...
	feedl := strings.Replace(feedk, "</description1><pubDate>", "&lt;p&gt;Follow @omni_quotes for more daily #quotes #instaquotes #motivation #inspiration&lt;/p&gt;</title><pubDate>", -1)
	//restore description
	...
	feedo := strings.Replace(feedn, "<channel>", "<channel><title>Quotes by @omni_quotes</title>", -1)
