...
func handler(w http.ResponseWriter, r *http.Request) {
	...
	feedl := strings.Replace(feedk, "</description1><pubDate>", "&lt;p&gt;&lt;a href=&quot;http://rplg.co/258f7f70&quot;&gt;More Home & Decor Stuff&lt;/a&gt;&lt;/p&gt;</title><pubDate>", -1)
	//restore description
	...
	feedo := strings.Replace(feedn, "<channel>", "<channel><title>Best Home and Decor</title>", -1)
